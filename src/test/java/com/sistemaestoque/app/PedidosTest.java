...
public class PedidosTest {
  ...
  public void adicionaPedidoEmPedidos(Pedido pedido) throws DescricaoEmBrancoException, ValorInvalidoException {
  ...
  static Stream<Pedido> pedidoProvider() throws DescricaoEmBrancoException, ValorInvalidoException {
    ...
    Produto produto2 = new Produto("Pasta de Dente", "Higiene Pessoal", "0001", 2.0f, 3.0f, 20, fornecedor, new Date());
    Produto produto3 = new Produto("Shampoo", "Produto para cabelo", "0002", 3.0f, 4.0f, 15, fornecedor, new Date());
