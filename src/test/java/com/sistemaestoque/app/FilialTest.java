...
public class FilialTest {
  ...
  void testTranferenciaProdutoEntre2Filiais(
      Filial filial1, Filial filial2, Produto prod, Integer qtdTransferida) {
  ...
  static Stream<Object> filialProvider() throws DescricaoEmBrancoException, ValorInvalidoException {
    ...
    Produto prod1 =
        new Produto(
            "Shampoo", "Produto de limpeza", "0001", 2.0f, 3.0f, 20, fornecedor, new Date());
    Produto prod2 =
        new Produto(
            "Shampoo", "Produto de limpeza", "0002", 2.0f, 3.0f, 20, fornecedor, new Date());
